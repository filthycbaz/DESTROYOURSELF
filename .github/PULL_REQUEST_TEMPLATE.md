<!--
Espejo de .agents/templates/pr-template.md — mantener ambos sincronizados.
pr-publisher (.claude/agents/pr-publisher.md) llena esta plantilla mecánicamente a partir de
datos ya producidos por otros agentes/reportes; nunca la completa inventando datos. Un campo sin
dato fuente queda sin marcar + "FALTA: [qué falta y de quién]".
-->
